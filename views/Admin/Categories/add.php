...
<head>
    ...
    <title> WIKIDash  - ADD new Category</title>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="container d-flex justify-content-center">
            <form action="AddCategory" method="post" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
                ...
                <div class="button-container">
                    ...
                    <a href="/WIKI/views/Admin/Categories.php" class="btn btn-danger" style="background-color: #959c9e;  border: 2px solid black"">Cancel</a>
            </div>
         </form>
      </div>
   </div>
